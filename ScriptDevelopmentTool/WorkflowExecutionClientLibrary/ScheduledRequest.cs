...
namespace Infosys.WEM.Client
{
    public class ScheduledRequest
    {
        ...
        public ScheduledRequest(string serviceUrl = "")
        {
        ...
        /// </summary>
        public IScheduleRequest ServiceChannel
        {
            get
            {
                ...
                if (!string.IsNullOrEmpty(_serviceUrl))
                    ...
                    _serviceAddress = WEMProxy.ServiceAddress(Services.WEMScheduledRequest);

                WebChannelFactory<IScheduleRequest> securityAccessChannel = new WebChannelFactory<IScheduleRequest>(serviceBinding, _serviceAddress);
