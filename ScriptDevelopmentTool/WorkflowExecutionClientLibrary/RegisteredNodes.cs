...
namespace Infosys.WEM.Client
{
    public class RegisteredNodes
    {
        ...
        public RegisteredNodes(string serviceUrl = "")
        {
        ...
        public INodes ServiceChannel
        {
            get
            {
                ...
                if (!string.IsNullOrEmpty(_serviceUrl))
                    ...
                    _serviceAddress = WEMProxy.ServiceAddress(Services.WEMNodeService);

                WebChannelFactory<INodes> securityAccessChannel = new WebChannelFactory<INodes>(serviceBinding, _serviceAddress);
