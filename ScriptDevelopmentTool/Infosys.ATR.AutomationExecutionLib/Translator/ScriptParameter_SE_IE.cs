...
{
    public class ScriptParameter_SE_IE
    {
        public static IE.Parameter ScriptParameterSEtoIE(ScriptParameter paramSE)
        {
        ...
        public static List<IE.Parameter> ScriptParameterListSEtoIE(List<ScriptParameter> paramsSE)
        {
            ...
            if (paramsSE != null && paramsSE.Count > 0)
            {
                ...
                paramsSE.ForEach(se => {
                    paramsIE.Add(ScriptParameterSEtoIE(se));
                });
            }
