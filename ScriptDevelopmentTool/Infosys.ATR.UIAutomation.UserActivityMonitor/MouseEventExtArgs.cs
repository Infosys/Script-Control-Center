...
namespace Infosys.ATR.UIAutomation.UserActivityMonitor
{
    ...
    /// </summary>
    public class MouseEventExtArgsHandler : MouseEventArgs
    {
        /// <summary>
        ...
        public MouseEventExtArgsHandler(MouseButtons buttons, int clicks, int x, int y, int delta)
        ...
        internal MouseEventExtArgsHandler(MouseEventArgs e) : base(e.Button, e.Clicks, e.X, e.Y, e.Delta)
        {}
