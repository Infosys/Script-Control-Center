...
using IAP.Infrastructure.Services;
    ...
    namespace InfrastructureClientLibrary
    {
        public class TicketHandlerService
        {
            ...
            public TicketHandlerService(string serviceUrl = "")
            {
            ...
            /// </summary>
            public ITicketHandler ServiceChannel
            {
                get
                {
                    ...
                    WebChannelFactory<ITicketHandler> channel = new WebChannelFactory<ITicketHandler>(serviceBinding, serviceAddress);
