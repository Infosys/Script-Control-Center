...
namespace Infosys.JavaAccessBridge
{
    ...
    //added to understand acessible actions
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
    ...
    public static class JABHelper
    {

        public const String WinAccessBridgeDll = @"wab\windowsaccessbridge.dll";
        ...
        //added to understand acessible actions
        [DllImport(WinAccessBridgeDll, SetLastError = true, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
        //public extern static Boolean getAccessibleActions(Int32 vmID, IntPtr AccessibleContext, out AccessibleActions accessibleActions);
        public extern static unsafe Boolean getAccessibleActions(Int32 vmID, IntPtr AccessibleContext, IntPtr accessibleActions);
