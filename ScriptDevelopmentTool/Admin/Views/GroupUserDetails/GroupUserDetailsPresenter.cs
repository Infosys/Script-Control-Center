...
{
    public class GroupUserDetailsPresenter : Presenter<IGroupUserDetails>
    {
        [EventPublication(EventTopicNames.RefreshGroupUsers, PublicationScope.WorkItem)]
        public event EventHandler<EventArgs> RefreshGroupUsers;
        ...
        internal bool AddUserToAGroup(Users users)
        {
        ...
        public void RefreshGroupUsers_Handler()
        {
            RefreshGroupUsers(this, new EventArgs());
        }
    }
}
