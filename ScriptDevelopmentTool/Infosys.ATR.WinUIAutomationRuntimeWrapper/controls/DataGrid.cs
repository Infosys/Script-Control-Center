...
{
    public class DataGrid : Controls.Base.DataGridBase
    {
        private string className = "DataGrid";

        public DataGrid(IntPtr appWinHandle, IntPtr screenWinHandle, string automationId, string automationName, string applicationTreePath, string applicationType, string fullControlQualifier)
