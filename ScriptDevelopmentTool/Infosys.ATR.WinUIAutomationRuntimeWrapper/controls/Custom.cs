...
{
    public class Custom : Controls.Base.CustomBase
    {
        private string className = "Custom";

        public Custom(IntPtr appWinHandle, IntPtr screenWinHandle, string automationId, string automationName, string applicationTreePath, string applicationType, string fullControlQualifier)
