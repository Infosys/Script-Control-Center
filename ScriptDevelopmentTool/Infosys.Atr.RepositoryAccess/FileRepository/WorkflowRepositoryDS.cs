...
namespace Infosys.ATR.RepositoryAccess.FileRepository
{
    public class WorkflowRepositoryDS
    {
        ...
        /// <summary>
        /// Input the secure script file stream from the document source configured
        /// </summary>
        /// <param name="SecureStream">An object containing the Secure Script file Stream 
        /// from source configured</param>
        /// <returns>An object containing the Unsecure/decrypted script stream </returns>
