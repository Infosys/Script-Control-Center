...
namespace Infosys.ATR.ScriptRepository.Views
{
    public partial class PythonIDE : UserControl, IPythonIDE, IClose
    {
        ...
        public delegate void TextChange(bool isDirty);
        public event TextChange TextChange_Handler;
        ...
        public PythonIDE()
        {
            ...
            scintilla1.TextDeleted += scintilla1_TextDeleted;
            scintilla1.TextInserted += scintilla1_TextInserted;

        }

        void IsDirty(bool isDirty)
        {
            Infosys.ATR.ScriptRepository.Save.Tabs[this] = isDirty;
        }

        void scintilla1_TextInserted(object sender, ScintillaNET.TextModifiedEventArgs e)
        {
            IsDirty(false);
            if (TextChange_Handler != null)
                TextChange_Handler(false);
        }
