      ...
      public static SE.Category CategoryDEtoSE(DE.Category categoryDE)
        {
            ...
            if (categoryDE != null)
            {
                ...
                categorySE.CompanyId = categoryDE.CompanyId.GetValueOrDefault();
                categorySE.ModuleID = categoryDE.ModuleID.Value;
            }
      ...
      public static DE.Category CategorySEtoDE(SE.Category categorySE)
      {
          ...
          if (categorySE != null)
          {
             ...
             // if (!string.IsNullOrEmpty(categorySE.CreatedBy))
              ...
              categoryDE.Name =  String.IsNullOrEmpty(categorySE.NewName) ? categorySE.Name : categorySE.NewName;
              var companyID = categoryDE.CompanyId = categorySE.CompanyId;
              categoryDE.PartitionKey = categorySE.ParentCategoryId == 0 ? companyID+"_ROOT" : companyID+"_"+categorySE.ParentCategoryId.ToString("00000");
              ...
              categoryDE.CategoryId = categorySE.CategoryId;
              categoryDE.ModuleID = categorySE.ModuleID;
