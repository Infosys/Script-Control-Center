...
namespace Infosys.WEM.AutomationActivity.Libraries
{
    public sealed class Alert : NativeActivity
    {
        ...
        [RequiredArgument]
        [System.ComponentModel.DisplayName("Type : 0 for Information, 1 for Warning, 2 for Error")] //similary add any other types as needed and accordingly update the switch below
